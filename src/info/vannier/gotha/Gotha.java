...
public class Gotha {
    ...
    static final int MAX_NUMBER_OF_BZHGROUPS = 9;
    ...
    * Returns X.yy.zz if minor version != 0
    ...
    public static boolean isAdmin(){
        int hashRef = -805867433;
        
        Preferences prefsRoot = Preferences.userRoot();
        Preferences gothaPrefs = prefsRoot.node(Gotha.strPreferences);
        
        String strK = "AdminPW";
        String strPW = gothaPrefs.get(strK, "def");
        
        int hash = strPW.hashCode();
                
        if (hash == hashRef) return true;
        else return false;        
    }
...
//        s = s.replaceAll("[[^a-z]&&[^A-Z]&&[^ ]]", "");
    ...
    public static Image getIconImage() {
        URL iconURL = null;
        try {
            iconURL = new URL("file:///" + Gotha.runningDirectory + "/resources/gothalogo64.png");
        } catch (MalformedURLException ex) {
            Logger.getLogger(Gotha.class.getName()).log(Level.SEVERE, null, ex);
        }
...
//            Logger.getLogger(Gotha.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static String getLocalUUID(){
        ...
        String strK = "localUUID";
        String strLocalUUID = gothaPrefs.get(strK, "");
