...
public class PlacementParameterSet implements java.io.Serializable{
    ...
    final static int PLA_CRIT_BZS    = 500;     // Breizh score
    ...
    final static int PLA_CRIT_SOSB   = 510;	// Sum of Opponents Breizh scores
    final static int PLA_CRIT_SOSBM1 = 511;	// Sum of (n-1)Opponents BZS
    final static int PLA_CRIT_SOSBM2 = 512;	// Sum of (n-2)Opponents BZS
    final static int PLA_CRIT_SODOSB = 520;	// Sum of Defeated opponents Breizh scores
    final static int PLA_CRIT_SOSOSB = 530;	// Sum of opponents SOS 
    
    
    final static int PLA_CRIT_SOSTS  = 310;     // Sum of Opponents Strasbourg scores

    final static int PLA_CRIT_EXT    = 801;     // Exploits Reussis
    final static int PLA_CRIT_EXR    = 802;     // Exploits Tentes
    
    final static int PLA_CRIT_SDC    = 901;     // Simplified Direct Confrontation 
    final static int PLA_CRIT_DC     = 902;     // Direct Confrontation 
    ...
    final static PlacementCriterion[] allPlacementCriteria = {
        ...
        new PlacementCriterion(PLA_CRIT_BZS, "BZS", "BZS", "Breizh Score", 2),
        ...
        new PlacementCriterion(PLA_CRIT_SOSB, "SOS", "SOSB", "Sum of Opponents Scores (BZS)", 2),
        new PlacementCriterion(PLA_CRIT_SOSBM1, "SOS-1", "SOSB-1", "Sum of (n-1) Best Opponents Scores (BZS)", 2),
        new PlacementCriterion(PLA_CRIT_SOSBM2, "SOS-2", "SOSB-2", "Sum of (n-2) Best Opponents Scores (BZS)", 2),
        new PlacementCriterion(PLA_CRIT_SODOSB, "SODOS", "SODOSB", "Sum of Defeated Opponents Scores (BZS)", 4),
        ...
        new PlacementCriterion(PLA_CRIT_SOSOSB, "SOSOS", "SOSOSB", "Sum of Opponents SOSB", 2),
...
//        plaCriteria[1] = PLA_CRIT_NUL;
    ...
    public void initForBreizh(){
        plaCriteria = new int[PLA_MAX_NUMBER_OF_CRITERIA];
        plaCriteria[0] = PLA_CRIT_BZS;
        plaCriteria[1] = PLA_CRIT_SOSB;
        plaCriteria[2] = PLA_CRIT_SOSOSB;
        plaCriteria[3] = PLA_CRIT_NUL;
        plaCriteria[4] = PLA_CRIT_NUL;
        plaCriteria[5] = PLA_CRIT_NUL;
    }
    ...
    public int mainCriterion(){
        ...
        for (int iC = 0; iC < crit.length; iC++){
            ...
            if (crit[iC] == PlacementParameterSet.PLA_CRIT_BZS){
                return PlacementParameterSet.PLA_CRIT_BZS;
            }
        }  
        return mainCrit;
    }
