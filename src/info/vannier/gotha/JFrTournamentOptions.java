...
public class JFrTournamentOptions extends javax.swing.JFrame{
    ...
    private void initComponents() {
        ...
        btnEditBZHGroups = new javax.swing.JButton();
        ...
        pnlPrivacy = new javax.swing.JPanel();
        ckbPrivacy = new javax.swing.JCheckBox();
        ...
        rdbHdBaseBZS = new javax.swing.JRadioButton();
        ...
        rdbMcMahon.setBounds(180, 70, 170, 13);
        ...
        rdbCup.setBounds(180, 160, 170, 13);
        ...
        lblRecommended.setBounds(220, 140, 250, 13);
        ...
        ckbResetParameters.setBounds(80, 10, 400, 23);
        ...
        rdbSwiss.setBounds(180, 100, 170, 13);

        grpNewSystem.add(rdbBreizh);
        ...
        dlgChangeSystem.getContentPane().add(rdbBreizh);
        rdbBreizh.setBounds(180, 190, 170, 13);
        ...
        btnClose.setBounds(470, 490, 300, 40);
        ...
        pnlBZHGroups.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createTitledBorder(""), "BZH Groups"));
        pnlBZHGroups.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                pnlBZHGroupsFocusLost(evt);
            }
        });
        pnlBZHGroups.setLayout(null);

        jLabel43.setText("Number of groups");
        pnlBZHGroups.add(jLabel43);
        jLabel43.setBounds(10, 30, 140, 14);

        jLabel44.setText("Lower limits :");
        pnlBZHGroups.add(jLabel44);
        jLabel44.setBounds(10, 60, 100, 14);
        ...
        pnlBZHGroups.add(txfNumberOfBZHGroups);
        txfNumberOfBZHGroups.setBounds(160, 30, 20, 20);

        btnEditBZHGroups.setText("Edit Breizh groups");
        btnEditBZHGroups.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnEditBZHGroupsActionPerformed(evt);
            }
        });
        pnlBZHGroups.add(btnEditBZHGroups);
        btnEditBZHGroups.setBounds(10, 80, 180, 30);

        pnlGen.add(pnlBZHGroups);
        pnlBZHGroups.setBounds(560, 40, 200, 300);
        ...
        pnlTournamentDetails.setBounds(10, 10, 280, 200);
        ...
        rdbAbsentNBW0.setBounds(150, 20, 40, 15);
        ...
        rdbAbsentNBW1.setBounds(190, 20, 40, 15);
        ...
        rdbAbsentNBW2.setBounds(230, 20, 40, 15);
        ...
        rdbAbsentMMS0.setBounds(150, 40, 40, 15);
        ...
        rdbAbsentMMS1.setBounds(190, 40, 40, 15);
        ...
        rdbAbsentMMS2.setBounds(230, 40, 40, 15);
        ...
        rdbByeNBW0.setBounds(150, 60, 40, 15);
        ...
        rdbByeNBW1.setBounds(190, 60, 40, 15);
        ...
        rdbByeNBW2.setBounds(230, 60, 40, 15);
        ...
        rdbByeMMS0.setBounds(150, 80, 40, 15);
        ...
        rdbByeMMS1.setBounds(190, 80, 40, 15);
        ...
        rdbByeMMS2.setBounds(230, 80, 40, 15);
        ...
        jLabel16.setText("MMS/BZS for Absent player");
        ...
        jLabel18.setText("MMS/BZS for Bye player ");
        ...
        ckbRoundDown.setText("Round down NBW and MMS/BZS scores");
        ...
        pnlSpecialResults.setBounds(10, 220, 280, 170);
        ...
        btnHelpGeneral.setIcon(new javax.swing.ImageIcon(getClass().getResource("/info/vannier/gotha/gothalogo16.png"))); // NOI18N
        ...
        pnlPrivacy.setBorder(javax.swing.BorderFactory.createTitledBorder("Privacy"));
        pnlPrivacy.setLayout(null);

        ckbPrivacy.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        ckbPrivacy.setText("Keep this tournament private");
        ckbPrivacy.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                ckbPrivacyFocusLost(evt);
            }
        });
        pnlPrivacy.add(ckbPrivacy);
        ckbPrivacy.setBounds(10, 20, 250, 21);

        pnlGen.add(pnlPrivacy);
        pnlPrivacy.setBounds(10, 400, 280, 50);
        ...
        rdbHdCorrection0.setBounds(20, 190, 180, 20);
        ...
        rdbHdCorrection1.setBounds(20, 210, 180, 20);
        ...
        rdbHdCorrection2.setBounds(20, 230, 180, 20);
        ...
        rdbHdCorrectionPlus1.setBounds(20, 280, 180, 20);

        jLabel10.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        jLabel10.setText("Handicap ceiling : ");
        pnlHandicap.add(jLabel10);
        jLabel10.setBounds(10, 320, 210, 13);
        ...
        txfHdCeiling.setBounds(230, 320, 40, 20);
        ...
        rdbHdBaseMMS.setBounds(20, 110, 150, 20);

        grpHdBase.add(rdbHdBaseBZS);
        rdbHdBaseBZS.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        rdbHdBaseBZS.setText("BZS");
        rdbHdBaseBZS.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                rdbHdBaseBZSActionPerformed(evt);
            }
        });
        pnlHandicap.add(rdbHdBaseBZS);
        rdbHdBaseBZS.setBounds(20, 130, 150, 20);

        jLabel30.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        jLabel30.setText("Handicap correction");
        pnlHandicap.add(jLabel30);
        jLabel30.setBounds(10, 170, 160, 13);
        ...
        rdbHdCorrection3.setBounds(20, 250, 180, 20);
        ...
        rdbHdBaseRank.setBounds(20, 90, 150, 20);

        pnlHan.add(pnlHandicap);
        pnlHandicap.setBounds(10, 50, 300, 370);

        btnHelpHandicap.setIcon(new javax.swing.ImageIcon(getClass().getResource("/info/vannier/gotha/gothalogo16.png"))); // NOI18N
        ...
        btnHelpPlacement.setIcon(new javax.swing.ImageIcon(getClass().getResource("/info/vannier/gotha/gothalogo16.png"))); // NOI18N
        ...
        btnHelpPairing.setIcon(new javax.swing.ImageIcon(getClass().getResource("/info/vannier/gotha/gothalogo16.png"))); // NOI18N
        ...
        btnHelpTeamPlacement.setIcon(new javax.swing.ImageIcon(getClass().getResource("/info/vannier/gotha/gothalogo16.png"))); // NOI18N
        ...
        btnHelpTeamPlacement.setBounds(470, 390, 110, 30);
        ...
        btnPrint.setBounds(20, 490, 430, 40);
    ...
    private void btnDlgChangeSystemOKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDlgChangeSystemOKActionPerformed
        ...
        if (this.rdbBreizh.isSelected()) system = TournamentParameterSet.TYPE_BREIZH;
...
//                dpps.initForCup();
    ...
    private void btnChangeSystemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnChangeSystemActionPerformed
        ...
        if (tournamentType == TournamentParameterSet.TYPE_BREIZH) rdbBreizh.setSelected(true);
    ...
    private void rdbAbsentOrByeFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_rdbAbsentOrByeFocusLost
        ...
        if (newGenMMS2ValueAbsent != gps.getGenMMSBZ2ValueAbsent()){
            gps.setGenMMSBZS2ValueAbsent(newGenMMS2ValueAbsent);
            bSomethingHasChanged = true;
        }
        ...
        if (newGenMMS2ValueBye != gps.getGenMMSBZS2ValueBye()){
            gps.setGenMMSBZS2ValueBye(newGenMMS2ValueBye);
            bSomethingHasChanged = true;
        }
    ...
    private void rdbHdBaseBZSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rdbHdBaseBZSActionPerformed
        this.updHdBase();
    }//GEN-LAST:event_rdbHdBaseBZSActionPerformed
    ...
    private void ckbResetParametersActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ckbResetParametersActionPerformed
        ...
        this.rdbBreizh.setEnabled(!bResetSelected);
    ...
    TournamentParameterSet tps;
        ...
        if (newNbBZHGroups <= 0 || newNbBZHGroups > Gotha.MAX_NUMBER_OF_CATEGORIES){
            ...
            for (int bg = 0; bg < newLowerBZHGroupLimits.length; bg++ ){
                if (bg < oldLowerBZHGroupLimits.length) newLowerBZHGroupLimits[bg] = oldLowerBZHGroupLimits[bg];
    ...
    private void pnlBZHGroupsFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_pnlBZHGroupsFocusLost
        // TODO add your handling code here:
    }//GEN-LAST:event_pnlBZHGroupsFocusLost

    private void btnEditBZHGroupsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditBZHGroupsActionPerformed
        try {
            JFrame jfr = new JFrPlayersBZG(tournament);
            this.displayFrame(jfr, JFrGotha.MEDIUM_FRAME_WIDTH, JFrGotha.BIG_FRAME_HEIGHT);
        } catch (RemoteException ex) {
            Logger.getLogger(JFrGotha.class.getName()).log(Level.SEVERE, null, ex);
        }        // TODO add your handling code here:
    }//GEN-LAST:event_btnEditBZHGroupsActionPerformed

    private void ckbPrivacyFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_ckbPrivacyFocusLost
        boolean bSomethingHasChanged = false;
        boolean newPrivateTournament = this.ckbPrivacy.isSelected();
        try {
            if (newPrivateTournament != tournament.isPrivateTournament()){
                tournament.setPrivateTournament(newPrivateTournament);
                bSomethingHasChanged = true;
            }
        } catch (RemoteException ex) {
            Logger.getLogger(JFrTournamentOptions.class.getName()).log(Level.SEVERE, null, ex);
    ...
    }//GEN-LAST:event_ckbPrivacyFocusLost
    ...
    private void updHdBase(){
        ...
        HandicapParameterSet hps = tps.getHandicapParameterSet();
        int oldHdBase = hps.getHdBase();
        int newHdBase = HandicapParameterSet.HD_BASED_ON_RANK;
        if (rdbHdBaseMMS.isSelected()) newHdBase = HandicapParameterSet.HD_BASED_ON_MMS;;
        if (rdbHdBaseBZS.isSelected()) newHdBase = HandicapParameterSet.HD_BASED_ON_BZS;;
        if (newHdBase == oldHdBase) return;
        hps.setHdBase(newHdBase);
        tps.setHandicapParameterSet(hps);
        try {
            tournament.setTournamentParameterSet(tps);
            this.tournamentChanged();
...
//        this.tpnParameters.setBounds(0, 0, w - 6, h - 84);
        this.tpnParameters.setBounds(0, 0, w - 6, h - 74);
        initPnlGen();
        initPnlHan();
        initPnlPla();
        initPnlPai();
    ...
    private void updatePnlGen()throws RemoteException{
        ...
        if (tournamentType == TournamentParameterSet.TYPE_UNDEFINED){
            ...
            this.pnlBZHGroups.setVisible(false); 
        ...
        if (tournamentType == TournamentParameterSet.TYPE_BREIZH){
            this.pnlTournamentDetails.setVisible(true);
            this.lblSystemName.setVisible(true);
            this.lblSystemName.setText("Breizh system");
            this.pnlCategories.setVisible(false);
            this.pnlBZHGroups.setVisible(true); 
            this.pnlMcMahon.setVisible(false);
        }
...
//                tabLblNbPlayersOfCat[c].setBounds(160, 120 + 20 * c, 30, 20);
        ...
        // BZHGroups Panel
        if (this.pnlBZHGroups.isVisible()){
            int nbBZG = gps.getNumberOfBZHGroups();
            this.txfNumberOfBZHGroups.setText("" + nbBZG);  
            if (tabLblBZG != null){
                for (int g = 0; g < tabLblBZG.length; g++){
                    pnlBZHGroups.remove(tabLblBZG[g]);
                }
            }            
            if (tabTxfLowerLimitOfBZG != null){
                for (int g = 0; g < tabTxfLowerLimitOfBZG.length; g++){
                    pnlBZHGroups.remove(tabTxfLowerLimitOfBZG[g]);
                }
            }
            if (tabLblNbPlayersOfBZG != null){
                for (int g = 0; g < tabLblNbPlayersOfBZG.length; g++){
                    pnlBZHGroups.remove(tabLblNbPlayersOfBZG[g]);
                }
            }
            
            // Dimensions for pnlBZHGroups and its components
            int tpgcPnlWidth = 220;
            int tpgcPnlHeadHeight = 80;
            int tpgcPnlBottomHeight = 60;
            ...
            tabLblBZG = new JLabel[nbBZG];
            tabTxfLowerLimitOfBZG = new JTextField[nbBZG];
            tabLblNbPlayersOfBZG = new JLabel[nbBZG];
            pnlBZHGroups.setSize(tpgcPnlWidth, tpgcPnlHeadHeight + tpgcLblHeight * nbBZG + tpgcPnlBottomHeight);
            for (int bg = 0; bg < nbBZG; bg++){
                // BZHGroups Labels
                tabLblBZG[bg] = new JLabel("Group " + (bg + 1));
//                tabLblCat[c].setBounds(30, 120 + 20 * c, 80, 20);
                tabLblBZG[bg].setBounds(tpgcLblLeft, tpgcPnlHeadHeight + tpgcLblHeight * bg, tpgcLblWidth, tpgcLblHeight);
                pnlBZHGroups.add(tabLblBZG[bg]);
                tabLblBZG[bg].updateUI();
                // Lower limits Text fields
                int niv = (bg < nbBZG -1) ? gps.getLowerBZHGroupLimits()[bg] : -30;
//                int niv = (g < nbBZG -1) ? - 3 * g : -30;

                String strNiv = Player.convertIntToKD(niv);
                tabTxfLowerLimitOfBZG[bg] = new JTextField(strNiv);
//                tabTxfLowerLimitOfCat[c].setBounds(120, 120 + 20 * c, 30, 20);
                tabTxfLowerLimitOfBZG[bg].setBounds(tpgcTxfLeft, tpgcPnlHeadHeight + tpgcLblHeight * bg, tpgcTxfWidth, tpgcLblHeight);
                pnlBZHGroups.add(tabTxfLowerLimitOfBZG[bg]);
                tabTxfLowerLimitOfBZG[bg].updateUI();
                if (bg < nbBZG -1){
                    tabTxfLowerLimitOfBZG[bg].setEditable(true);
                ...
                else tabTxfLowerLimitOfBZG[bg].setEditable(false);
                // number of players in the category Text Field
                int nbPl = tournament.numberOfPlayersStrongerOrEqualTo(niv);
//                if (g > 0) nbPl -= tournament.numberOfPlayersStrongerOrEqualTo(gps.getLowerCategoryLimits()[g-1]);
                  if (bg > 0) nbPl = nbPl - tournament.numberOfPlayersStrongerOrEqualTo(gps.getLowerBZHGroupLimits()[bg-1]);;
                tabLblNbPlayersOfBZG[bg] = new JLabel("" + nbPl);
                tabLblNbPlayersOfBZG[bg].setBounds(tpgcNbPLeft, tpgcPnlHeadHeight + tpgcLblHeight * bg, tpgcNbPWidth, tpgcLblHeight);
                pnlBZHGroups.add(tabLblNbPlayersOfBZG[bg]);
                tabLblNbPlayersOfBZG[bg].updateUI();
            }
            this.btnEditBZHGroups.setBounds(10, tpgcPnlHeadHeight + tpgcLblHeight * nbBZG + 20, 180, 30);
        ...
        this.ckbPrivacy.setSelected(tournament.isPrivateTournament());
    }
...
//            else this.rdbHdBaseBZS.setSelected(true);
            
            switch(hps.getHdBase()){
                case HandicapParameterSet.HD_BASED_ON_RANK : this.rdbHdBaseRank.setSelected(true); break;
                case HandicapParameterSet.HD_BASED_ON_MMS  : this.rdbHdBaseMMS.setSelected(true); break;
                case HandicapParameterSet.HD_BASED_ON_BZS  : this.rdbHdBaseBZS.setSelected(true); break;
            }
...
//        RatingList rlFFG = new RatingList(RatingList.TYPE_FFG, new File(Gotha.runningDirectory, "ratinglists/ech_ffg_new.txt"));
    ...
    private javax.swing.JButton btnEditBZHGroups;
    ...
    private javax.swing.JCheckBox ckbPrivacy;
    ...
    private javax.swing.JPanel pnlPrivacy;
    ...
    private javax.swing.JRadioButton rdbHdBaseBZS;
