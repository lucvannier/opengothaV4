...
public class JFrPublish extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        rdbSortByBZG = new javax.swing.JRadioButton();
        ...
        rdbSortByName.setBounds(130, 10, 110, 23);
        ...
        rdbSortByRank.setBounds(130, 40, 110, 23);

        grpSortType.add(rdbSortByBZG);
        rdbSortByBZG.setText("BZH group");
        rdbSortByBZG.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                allSortRDBActionPerformed(evt);
            }
        });
        pnlPL.add(rdbSortByBZG);
        rdbSortByBZG.setBounds(130, 70, 110, 23);

        pnlContents.add(pnlPL);
        pnlPL.setBounds(10, 20, 300, 110);
        ...
        ckbShowByePlayer.setBounds(10, 20, 270, 20);
        ...
        ckbShowNotPairedPlayers.setBounds(10, 40, 270, 20);
        ...
        ckbShowNotParticipatingPlayers.setBounds(10, 60, 270, 20);
        ...
        ckbShowNotFinallyRegisteredPlayers.setBounds(10, 80, 270, 20);

        pnlContents.add(pnlNPP);
        pnlNPP.setBounds(10, 140, 300, 110);
        ...
        pnlSt.setBounds(10, 260, 670, 150);
...
//        this.rdbSortByRank.setVisible(false);
    ...
    private void allSortRDBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_allSortRDBActionPerformed
        ...
        if (this.rdbSortByBZG.isSelected()) {
            newPlayerSortType = PlayerComparator.SBZS_RATING_ORDER;
        }
    ...
    private void updatePnlContents() throws RemoteException {
        ...
        } else if (dpps.getPlayerSortType() == PlayerComparator.RANK_ORDER){
            this.rdbSortByRank.setSelected(true);
        } else if (dpps.getPlayerSortType() == PlayerComparator.SBZS_RATING_ORDER){
            this.rdbSortByBZG.setSelected(true);
        }
    ...
    private javax.swing.JRadioButton rdbSortByBZG;
