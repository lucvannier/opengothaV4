...
public class TournamentParameterSet implements java.io.Serializable{
    ...
    public final static int TYPE_BREIZH     = 5;
    ...
    public int tournamentType(){    
        ...
        switch(plaCrit[0]){
            ...
            case PlacementParameterSet.PLA_CRIT_BZS : return TournamentParameterSet.TYPE_BREIZH;
            default : return TournamentParameterSet.TYPE_UNDEFINED;
        }
    }

    public void initBase(){
        initBase("Undefined", "Undefined", "", "", new java.util.Date (),  new java.util.Date (), 5, 1, 1);
    }
    ...
    public void initBase(String shortName, String name, String location, String director,
        ...
        beginDate, endDate, numberOfRounds,  numberOfCategories, numberOfBZHGroups);
    }
    ...
    public void initForBreizh(){
        generalParameterSet.initForBreizh();
        handicapParameterSet.initForBreizh();
        placementParameterSet.initForBreizh();
        pairingParameterSet.initForBreizh();
//        dpParameterSet.initForCup();
//        publishParameterSet.initForCup();
    }
