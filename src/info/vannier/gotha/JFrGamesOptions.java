...
//    private static final long REFRESH_DELAY = 2000;
    ...
    private void initComponents() {
        ...
        cbInternetGame = new javax.swing.JCheckBox();
        ...
        cbInternetGame.setText("Internet game");
        cbInternetGame.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                cbInternetGameFocusLost(evt);
            }
        });
        pnlTime.add(cbInternetGame);
        cbInternetGame.setBounds(110, 20, 120, 23);
    ...
    private void cbInternetGameFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_cbInternetGameFocusLost
        try {
            TournamentParameterSet tps = tournament.getTournamentParameterSet();
            GeneralParameterSet gps = tps.getGeneralParameterSet();
            boolean oldVal = gps.isBInternetGame();
            boolean newVal = this.cbInternetGame.isSelected();
            if (newVal == oldVal) {
                return;
            }
            gps.setBInternetGame(newVal);
            tournament.setTournamentParameterSet(tps);
            this.tournamentChanged();
        } catch (RemoteException ex) {
            Logger.getLogger(JFrGamesOptions.class.getName()).log(Level.SEVERE, null, ex);
        }
    }//GEN-LAST:event_cbInternetGameFocusLost
    ...
    private void updatePnlGam() throws RemoteException {
        ...
        this.cbInternetGame.setSelected(gps.isBInternetGame());
    ...
    private javax.swing.JCheckBox cbInternetGame;
