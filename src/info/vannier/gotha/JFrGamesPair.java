...
public class JFrGamesPair extends javax.swing.JFrame {
    ...
    private void updateComponents() {
        ...
        if (byePlayer == null) {
            ...
            String byeName = byePlayer.fullName();
            if (this.rdbUserName.isSelected()) byeName = byePlayer.getUserName();
            txfByePlayer.setText(byeName
    ...
    private void fillGamesTable(ArrayList<Game> alG, JTable tblG) {
        ...
        for (Game g : alDisplayedGames) {
            ...
            String wName = wP.fullName();
            String bName = bP.fullName();
            if (this.rdbUserName.isSelected()){
                wName = wP.getUserName();
                bName = bP.getUserName();
            }
            row.add(wName);
            row.add(bName);
    ...
    private void initComponents() {
        ...
        grpDispayName = new javax.swing.ButtonGroup();
        pupGames = new javax.swing.JPopupMenu();
        mniRenumberTablesByBestScoreThenRating = new javax.swing.JMenuItem();
        ...
        mniRenumberTablesByBestScoreThenRating.setText("Renumber all tables by best score/rating");
        mniRenumberTablesByBestScoreThenRating.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                mniRenumberTablesByBestScoreThenRatingActionPerformed(evt);
            }
        });
        pupGames.add(mniRenumberTablesByBestScoreThenRating);
        ...
        pnlPlayers.setBounds(0, 50, 280, 470);
        ...
        spnRoundNumber.setBounds(50, 10, 40, 30);
        ...
        pnlInternal.add(jLabel15);
        jLabel15.setBounds(120, 20, 50, 14);

        grpDispayName.add(rdbName);
        ...
        pnlInternal.add(rdbName);
        rdbName.setBounds(170, 10, 100, 23);

        grpDispayName.add(rdbUserName);
        ...
        pnlInternal.add(rdbUserName);
        rdbUserName.setBounds(170, 30, 100, 23);
...
//        boolean bRemoveAllGames = false;
    ...
    private void btnPairActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPairActionPerformed
        ...
        try {
            tournament.renumberTablesByBestScoreThenRating(processedRoundNumber, alNewGames);
        } catch (RemoteException ex) {
            Logger.getLogger(JFrGamesPair.class.getName()).log(Level.SEVERE, null, ex);
        }
...
//        dlgPairingReport.setVisible(true);
    ...
    private void mniRenumberTablesByBestScoreThenRatingActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mniRenumberTablesByBestScoreThenRatingActionPerformed
        pupGames.setVisible(false);
        try {
            tournament.renumberTablesByBestScoreThenRating(processedRoundNumber, this.selectedGamesList());
            this.tournamentChanged();
        } catch (RemoteException ex) {
            Logger.getLogger(JFrGamesPair.class.getName()).log(Level.SEVERE, null, ex);
        }
    }//GEN-LAST:event_mniRenumberTablesByBestScoreThenRatingActionPerformed
    ...
    private javax.swing.ButtonGroup grpDispayName;
    ...
    private javax.swing.JMenuItem mniRenumberTablesByBestScoreThenRating;
