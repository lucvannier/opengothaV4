...
public interface TournamentInterface extends Remote{
    ...
    public void setSaveDT(Date saveDT) throws RemoteException;   public String getExternalIPAddress()throws RemoteException;
    public void setExternalIPAddress(String externalIPAddress) throws RemoteException;
    public String getRemoteUUID()throws RemoteException;
    public void setRemoteUUID(String strRemoteUUID) throws RemoteException;
...
//    public int numberOfPlayersInBZHGroup(int numBZG, ArrayList<ScoredPlayer> alSP) throws RemoteException;
