...
public class Player implements java.io.Serializable{
     ...
     */
    private int smmbzsCorrection = 0;
    ...
    public Player(String name, String firstName, String userName, String country, String club, String egfPin, String ffgLicence, String ffgLicenceStatus,
        ...
        this(name, firstName, country, club, egfPin, ffgLicence, ffgLicenceStatus,
                        agaId, agaExpirationDate, rank, rating, strRatingOrigin, strGrade, smmsCorrection, registeringStatus);
    ...
    public Player(String name, String firstName, String country, String club, String egfPin, String ffgLicence, String ffgLicenceStatus,
       ...
       this.club = club;
        ...
        this.smmbzsCorrection = smmsCorrection;
    ...
    public void deepCopy(Player p){
        ...
        this.smmbzsCorrection = p.getSmmbzsCorrection();
...
/** Concatenates name and firtName
   ...
   public int category(GeneralParameterSet gps){
      ...
      public int bzhGroup(GeneralParameterSet gps){
       if (gps.getNumberOfBZHGroups() <= 1) return 0;
       int[] bzg = gps.getLowerBZHGroupLimits();
        for (int bg = 0; bg < bzg.length; bg++){
            if ((this.rank + this.smmbzsCorrection) >= bzg[bg]) return bg;
        }
        return bzg.length;
    }
...
//        if (smms > bar + 30) smms = bar + 30;
        ...
        smms += smmbzsCorrection;
        
        return smms;
    }

    public int sbzs(GeneralParameterSet gps){        
        int nbBZG = gps.getNumberOfBZHGroups();
        int rk = getRank(); 
        int sbzs = 0;
        for(int bg = nbBZG - 2; bg >= 0; bg--){
            if(rk >= gps.getLowerBZHGroupLimits()[bg]) sbzs = nbBZG - bg - 1;
        }
        sbzs += smmbzsCorrection;
        return sbzs;
    }
...
//            Logger.getLogger(Player.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public int getSmmbzsCorrection() {
        return smmbzsCorrection;
    }

    public void setSmmbzsCorrection(int smmbzsCorrection) {
        this.smmbzsCorrection = smmbzsCorrection;
    }
